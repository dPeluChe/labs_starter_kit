"use client"; // Añadir esta directiva para convertirlo en un componente del cliente
...
export default function Hero() {
  ...
  return (
    <div className="relative bg-base-200 transition-colors duration-300">
      <div className="z-10">
        <Navbar />
      </div>
      <div className="min-h-screen flex items-center justify-center">
        <div className="container mx-auto px-4 py-16 flex flex-col lg:flex-row-reverse items-center gap-8">
          <div className="w-full lg:w-1/2">
            <div className="w-full h-64 lg:h-96 bg-base-300 rounded-lg flex items-center justify-center shadow-lg transition-all duration-300">
              <span className="text-base-content opacity-60">Hero Image</span>
            </div>
          </div>

...
export const metadata: Metadata = {
  title: 'Login - Feedby',
  description: 'Login to your Feedby account',
};
    ...
    <div className="min-h-screen flex items-center justify-center bg-base-200">
      <div className="card w-full max-w-md bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title text-2xl font-bold text-center mb-6">Login to Feedby</h2>
          ...
          <p className="text-center mt-6">
            Don't have an account? <a href="#" className="link link-hover link-primary">Sign up</a>
          </p>
        </div>
      </div>
    </div>
